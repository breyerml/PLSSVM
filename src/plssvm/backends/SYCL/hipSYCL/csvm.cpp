...
void csvm::init(const target_platform target) {
    ...
    plssvm::detail::log(verbosity_level::full,
                        ...
                        plssvm::detail::tracking::tracking_entry{ "backend", "version", ::hipsycl::sycl::detail::version_string() },
    ...
    PLSSVM_DETAIL_TRACKING_PERFORMANCE_TRACKER_ADD_TRACKING_ENTRY((plssvm::detail::tracking::tracking_entry{ "backend", "sycl_implementation_type", plssvm::sycl::implementation_type::hipsycl }));
